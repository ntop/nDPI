...
flow_risks[36] = ProtoField.bool("ndpi.flow_risk.dns_large_packet", "DNS large packet", num_bits_flow_risks, nil, bit(0), "nDPI Flow Risk: DNS packet is larger than 512 bytes")
