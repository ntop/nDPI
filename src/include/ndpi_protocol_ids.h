...
typedef enum {
  NDPI_PROTOCOL_EXT_UNKNOWN               = 0,
  NDPI_PROTOCOL_EXT_FTP_CONTROL           = 1,
  NDPI_PROTOCOL_EXT_MAIL_POP              = 2,
  NDPI_PROTOCOL_EXT_MAIL_SMTP             = 3,
  NDPI_PROTOCOL_EXT_MAIL_IMAP             = 4,
  NDPI_PROTOCOL_EXT_DNS                   = 5,
  NDPI_PROTOCOL_EXT_IPP                   = 6,
  NDPI_PROTOCOL_EXT_HTTP                  = 7,
  NDPI_PROTOCOL_EXT_MDNS                  = 8,
  NDPI_PROTOCOL_EXT_NTP                   = 9,
  NDPI_PROTOCOL_EXT_NETBIOS               = 10,
  NDPI_PROTOCOL_EXT_NFS                   = 11,
  NDPI_PROTOCOL_EXT_SSDP                  = 12,
  NDPI_PROTOCOL_EXT_BGP                   = 13,
  NDPI_PROTOCOL_EXT_SNMP                  = 14,
  NDPI_PROTOCOL_EXT_XDMCP                 = 15,
  NDPI_PROTOCOL_EXT_SMBV1                 = 16,
  NDPI_PROTOCOL_EXT_SYSLOG                = 17,
  NDPI_PROTOCOL_EXT_DHCP                  = 18,
  NDPI_PROTOCOL_EXT_POSTGRES              = 19,
  NDPI_PROTOCOL_EXT_MYSQL                 = 20,
  NDPI_PROTOCOL_EXT_HOTMAIL               = 21,
  NDPI_PROTOCOL_EXT_DIRECT_DOWNLOAD_LINK  = 22,
  NDPI_PROTOCOL_EXT_MAIL_POPS             = 23,
  NDPI_PROTOCOL_EXT_APPLEJUICE            = 24,
  NDPI_PROTOCOL_EXT_DIRECTCONNECT         = 25,
  NDPI_PROTOCOL_EXT_NTOP                  = 26,
  NDPI_PROTOCOL_EXT_COAP                  = 27,
  NDPI_PROTOCOL_EXT_VMWARE                = 28,
  NDPI_PROTOCOL_EXT_MAIL_SMTPS            = 29,
  NDPI_PROTOCOL_EXT_FBZERO                = 30,
  NDPI_PROTOCOL_EXT_UBNTAC2               = 31,
  NDPI_PROTOCOL_EXT_KONTIKI               = 32,
  NDPI_PROTOCOL_EXT_OPENFT                = 33,
  NDPI_PROTOCOL_EXT_FASTTRACK             = 34,
  NDPI_PROTOCOL_EXT_GNUTELLA              = 35,
  NDPI_PROTOCOL_EXT_EDONKEY               = 36,
  NDPI_PROTOCOL_EXT_BITTORRENT            = 37,
  NDPI_PROTOCOL_EXT_SKYPE_CALL            = 38,
  NDPI_PROTOCOL_EXT_SIGNAL                = 39,
  NDPI_PROTOCOL_EXT_MEMCACHED             = 40,
  NDPI_PROTOCOL_EXT_SMBV23                = 41,
  NDPI_PROTOCOL_EXT_MINING                = 42,
  NDPI_PROTOCOL_EXT_NEST_LOG_SINK         = 43,
  NDPI_PROTOCOL_EXT_MODBUS                = 44,
  NDPI_PROTOCOL_EXT_WHATSAPP_CALL         = 45,
  NDPI_PROTOCOL_EXT_DATASAVER             = 46,
  NDPI_PROTOCOL_EXT_XBOX                  = 47,
  NDPI_PROTOCOL_EXT_QQ                    = 48,
  NDPI_PROTOCOL_EXT_TIKTOK                = 49,
  NDPI_PROTOCOL_EXT_RTSP                  = 50,
  NDPI_PROTOCOL_EXT_MAIL_IMAPS            = 51,
  NDPI_PROTOCOL_EXT_ICECAST               = 52,
  NDPI_PROTOCOL_EXT_PPLIVE                = 53, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_PPSTREAM              = 54,
  NDPI_PROTOCOL_EXT_ZATTOO                = 55,
  NDPI_PROTOCOL_EXT_SHOUTCAST             = 56,
  NDPI_PROTOCOL_EXT_SOPCAST               = 57,
  NDPI_PROTOCOL_EXT_TVANTS                = 58, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_TVUPLAYER             = 59,
  NDPI_PROTOCOL_EXT_HTTP_DOWNLOAD         = 60,
  NDPI_PROTOCOL_EXT_QQLIVE                = 61,
  NDPI_PROTOCOL_EXT_THUNDER               = 62,
  NDPI_PROTOCOL_EXT_SOULSEEK              = 63,
  NDPI_PROTOCOL_EXT_PS_VUE                = 64,
  NDPI_PROTOCOL_EXT_IRC                   = 65,
  NDPI_PROTOCOL_EXT_AYIYA                 = 66,
  NDPI_PROTOCOL_EXT_UNENCRYPTED_JABBER    = 67,
  NDPI_PROTOCOL_EXT_MSN                   = 68, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_OSCAR                 = 69, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_YAHOO                 = 70,
  NDPI_PROTOCOL_EXT_BATTLEFIELD           = 71, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_GOOGLE_PLUS           = 72,
  NDPI_PROTOCOL_EXT_IP_VRRP               = 73,
  NDPI_PROTOCOL_EXT_STEAM                 = 74,
  NDPI_PROTOCOL_EXT_HALFLIFE2             = 75,
  NDPI_PROTOCOL_EXT_WORLDOFWARCRAFT       = 76,
  NDPI_PROTOCOL_EXT_TELNET                = 77,
  NDPI_PROTOCOL_EXT_STUN                  = 78,
  NDPI_PROTOCOL_EXT_IP_IPSEC              = 79,
  NDPI_PROTOCOL_EXT_IP_GRE                = 80,
  NDPI_PROTOCOL_EXT_IP_ICMP               = 81,
  NDPI_PROTOCOL_EXT_IP_IGMP               = 82,
  NDPI_PROTOCOL_EXT_IP_EGP                = 83,
  NDPI_PROTOCOL_EXT_IP_SCTP               = 84,
  NDPI_PROTOCOL_EXT_IP_OSPF               = 85,
  NDPI_PROTOCOL_EXT_IP_IP_IN_IP           = 86,
  NDPI_PROTOCOL_EXT_RTP                   = 87,
  NDPI_PROTOCOL_EXT_RDP                   = 88,
  NDPI_PROTOCOL_EXT_VNC                   = 89,
  NDPI_PROTOCOL_EXT_PCANYWHERE            = 90, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_TLS                   = 91,
  NDPI_PROTOCOL_EXT_SSH                   = 92,
  NDPI_PROTOCOL_EXT_USENET                = 93,
  NDPI_PROTOCOL_EXT_MGCP                  = 94,
  NDPI_PROTOCOL_EXT_IAX                   = 95,
  NDPI_PROTOCOL_EXT_TFTP                  = 96,
  NDPI_PROTOCOL_EXT_AFP                   = 97,
  NDPI_PROTOCOL_EXT_STEALTHNET            = 98,
  NDPI_PROTOCOL_EXT_AIMINI                = 99,
  NDPI_PROTOCOL_EXT_SIP                   = 100,
  NDPI_PROTOCOL_EXT_TRUPHONE              = 101,
  NDPI_PROTOCOL_EXT_IP_ICMPV6             = 102,
  NDPI_PROTOCOL_EXT_DHCPV6                = 103,
  NDPI_PROTOCOL_EXT_ARMAGETRON            = 104,
  NDPI_PROTOCOL_EXT_CROSSFIRE             = 105,
  NDPI_PROTOCOL_EXT_DOFUS                 = 106,
  NDPI_PROTOCOL_EXT_FIESTA                = 107,
  NDPI_PROTOCOL_EXT_FLORENSIA             = 108,
  NDPI_PROTOCOL_EXT_GUILDWARS             = 109,
  NDPI_PROTOCOL_EXT_HTTP_ACTIVESYNC       = 110,
  NDPI_PROTOCOL_EXT_KERBEROS              = 111,
  NDPI_PROTOCOL_EXT_LDAP                  = 112,
  NDPI_PROTOCOL_EXT_MAPLESTORY            = 113,
  NDPI_PROTOCOL_EXT_MSSQL_TDS             = 114,
  NDPI_PROTOCOL_EXT_PPTP                  = 115,
  NDPI_PROTOCOL_EXT_WARCRAFT3             = 116,
  NDPI_PROTOCOL_EXT_WORLD_OF_KUNG_FU      = 117,
  NDPI_PROTOCOL_EXT_SLACK                 = 118,
  NDPI_PROTOCOL_EXT_FACEBOOK              = 119,
  NDPI_PROTOCOL_EXT_TWITTER               = 120,
  NDPI_PROTOCOL_EXT_DROPBOX               = 121,
  NDPI_PROTOCOL_EXT_GMAIL                 = 122,
  NDPI_PROTOCOL_EXT_GOOGLE_MAPS           = 123,
  NDPI_PROTOCOL_EXT_YOUTUBE               = 124,
  NDPI_PROTOCOL_EXT_SKYPE                 = 125,
  NDPI_PROTOCOL_EXT_GOOGLE                = 126,
  NDPI_PROTOCOL_EXT_DCERPC                = 127,
  NDPI_PROTOCOL_EXT_NETFLOW               = 128,
  NDPI_PROTOCOL_EXT_SFLOW                 = 129,
  NDPI_PROTOCOL_EXT_HTTP_CONNECT          = 130,
  NDPI_PROTOCOL_EXT_HTTP_PROXY            = 131,
  NDPI_PROTOCOL_EXT_CITRIX                = 132,
  NDPI_PROTOCOL_EXT_NETFLIX               = 133,
  NDPI_PROTOCOL_EXT_LASTFM                = 134,
  NDPI_PROTOCOL_EXT_WAZE                  = 135,
  NDPI_PROTOCOL_EXT_YOUTUBE_UPLOAD        = 136,
  NDPI_PROTOCOL_EXT_HULU                  = 137,
  NDPI_PROTOCOL_EXT_CHECKMK               = 138,
  NDPI_PROTOCOL_EXT_AJP                   = 139,
  NDPI_PROTOCOL_EXT_APPLE                 = 140,
  NDPI_PROTOCOL_EXT_WEBEX                 = 141,
  NDPI_PROTOCOL_EXT_WHATSAPP              = 142,
  NDPI_PROTOCOL_EXT_APPLE_ICLOUD          = 143,
  NDPI_PROTOCOL_EXT_VIBER                 = 144,
  NDPI_PROTOCOL_EXT_APPLE_ITUNES          = 145,
  NDPI_PROTOCOL_EXT_RADIUS                = 146,
  NDPI_PROTOCOL_EXT_WINDOWS_UPDATE        = 147,
  NDPI_PROTOCOL_EXT_TEAMVIEWER            = 148,
  NDPI_PROTOCOL_EXT_TUENTI                = 149,
  NDPI_PROTOCOL_EXT_LOTUS_NOTES           = 150,
  NDPI_PROTOCOL_EXT_SAP                   = 151,
  NDPI_PROTOCOL_EXT_GTP                   = 152,
  NDPI_PROTOCOL_EXT_UPNP                  = 153,
  NDPI_PROTOCOL_EXT_LLMNR                 = 154,
  NDPI_PROTOCOL_EXT_REMOTE_SCAN           = 155,
  NDPI_PROTOCOL_EXT_SPOTIFY               = 156,
  NDPI_PROTOCOL_EXT_MESSENGER             = 157,
  NDPI_PROTOCOL_EXT_H323                  = 158,
  NDPI_PROTOCOL_EXT_OPENVPN               = 159,
  NDPI_PROTOCOL_EXT_NOE                   = 160,
  NDPI_PROTOCOL_EXT_CISCOVPN              = 161,
  NDPI_PROTOCOL_EXT_TEAMSPEAK             = 162,
  NDPI_PROTOCOL_EXT_TOR                   = 163,
  NDPI_PROTOCOL_EXT_SKINNY                = 164,
  NDPI_PROTOCOL_EXT_RTCP                  = 165,
  NDPI_PROTOCOL_EXT_RSYNC                 = 166,
  NDPI_PROTOCOL_EXT_ORACLE                = 167,
  NDPI_PROTOCOL_EXT_CORBA                 = 168,
  NDPI_PROTOCOL_EXT_UBUNTUONE             = 169,
  NDPI_PROTOCOL_EXT_WHOIS_DAS             = 170,
  NDPI_PROTOCOL_EXT_COLLECTD              = 171,
  NDPI_PROTOCOL_EXT_SOCKS                 = 172,
  NDPI_PROTOCOL_EXT_NINTENDO              = 173,
  NDPI_PROTOCOL_EXT_RTMP                  = 174,
  NDPI_PROTOCOL_EXT_FTP_DATA              = 175,
  NDPI_PROTOCOL_EXT_WIKIPEDIA             = 176,
  NDPI_PROTOCOL_EXT_ZMQ                   = 177,
  NDPI_PROTOCOL_EXT_AMAZON                = 178,
  NDPI_PROTOCOL_EXT_EBAY                  = 179,
  NDPI_PROTOCOL_EXT_CNN                   = 180,
  NDPI_PROTOCOL_EXT_MEGACO                = 181,
  NDPI_PROTOCOL_EXT_REDIS                 = 182,
  NDPI_PROTOCOL_EXT_PANDO                 = 183, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_VHUA                  = 184,
  NDPI_PROTOCOL_EXT_TELEGRAM              = 185,
  NDPI_PROTOCOL_EXT_VEVO                  = 186,
  NDPI_PROTOCOL_EXT_PANDORA               = 187,
  NDPI_PROTOCOL_EXT_QUIC                  = 188,
  NDPI_PROTOCOL_EXT_ZOOM                  = 189,
  NDPI_PROTOCOL_EXT_EAQ                   = 190,
  NDPI_PROTOCOL_EXT_OOKLA                 = 191,
  NDPI_PROTOCOL_EXT_AMQP                  = 192,
  NDPI_PROTOCOL_EXT_KAKAOTALK             = 193,
  NDPI_PROTOCOL_EXT_KAKAOTALK_VOICE       = 194,
  NDPI_PROTOCOL_EXT_TWITCH                = 195,
  NDPI_PROTOCOL_EXT_DNS_OVER_HTTPS        = 196, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_WECHAT                = 197,
  NDPI_PROTOCOL_EXT_MPEGTS                = 198,
  NDPI_PROTOCOL_EXT_SNAPCHAT              = 199,
  NDPI_PROTOCOL_EXT_SINA                  = 200,
  NDPI_PROTOCOL_EXT_HANGOUT_DUO           = 201,
  NDPI_PROTOCOL_EXT_IFLIX                 = 202,
  NDPI_PROTOCOL_EXT_GITHUB                = 203,
  NDPI_PROTOCOL_EXT_BJNP                  = 204,
  NDPI_PROTOCOL_EXT_LINE                  = 205, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_WIREGUARD             = 206,
  NDPI_PROTOCOL_EXT_SMPP                  = 207,
  NDPI_PROTOCOL_EXT_DNSCRYPT              = 208,
  NDPI_PROTOCOL_EXT_TINC                  = 209,
  NDPI_PROTOCOL_EXT_DEEZER                = 210,
  NDPI_PROTOCOL_EXT_INSTAGRAM             = 211,
  NDPI_PROTOCOL_EXT_MICROSOFT             = 212,
  NDPI_PROTOCOL_EXT_STARCRAFT             = 213,
  NDPI_PROTOCOL_EXT_TEREDO                = 214,
  NDPI_PROTOCOL_EXT_HOTSPOT_SHIELD        = 215,
  NDPI_PROTOCOL_EXT_IMO                   = 216,
  NDPI_PROTOCOL_EXT_GOOGLE_DRIVE          = 217,
  NDPI_PROTOCOL_EXT_OCS                   = 218,
  NDPI_PROTOCOL_EXT_MICROSOFT_365         = 219, /* Renamed in 3.4 */
  NDPI_PROTOCOL_EXT_OFFICE365             = NDPI_PROTOCOL_EXT_MICROSOFT_365,
  NDPI_PROTOCOL_EXT_CLOUDFLARE            = 220,
  NDPI_PROTOCOL_EXT_MS_ONE_DRIVE          = 221,
  NDPI_PROTOCOL_EXT_MQTT                  = 222,
  NDPI_PROTOCOL_EXT_RX                    = 223,
  NDPI_PROTOCOL_EXT_APPLESTORE            = 224,
  NDPI_PROTOCOL_EXT_OPENDNS               = 225,
  NDPI_PROTOCOL_EXT_GIT                   = 226,
  NDPI_PROTOCOL_EXT_DRDA                  = 227,
  NDPI_PROTOCOL_EXT_PLAYSTORE             = 228,
  NDPI_PROTOCOL_EXT_SOMEIP                = 229,
  NDPI_PROTOCOL_EXT_FIX                   = 230,
  NDPI_PROTOCOL_EXT_PLAYSTATION           = 231,
  NDPI_PROTOCOL_EXT_PASTEBIN              = 232,
  NDPI_PROTOCOL_EXT_LINKEDIN              = 233,
  NDPI_PROTOCOL_EXT_SOUNDCLOUD            = 234,
  NDPI_PROTOCOL_EXT_CSGO                  = 235,
  NDPI_PROTOCOL_EXT_LISP                  = 236,
  NDPI_PROTOCOL_EXT_DIAMETER              = 237,
  NDPI_PROTOCOL_EXT_APPLE_PUSH            = 238,
  NDPI_PROTOCOL_EXT_GOOGLE_SERVICES       = 239,
  NDPI_PROTOCOL_EXT_AMAZON_VIDEO          = 240,
  NDPI_PROTOCOL_EXT_GOOGLE_DOCS           = 241,
  NDPI_PROTOCOL_EXT_WHATSAPP_FILES        = 242,
  NDPI_PROTOCOL_EXT_TARGUS_GETDATA        = 243,
  NDPI_PROTOCOL_EXT_DNP3                  = 244,
  NDPI_PROTOCOL_EXT_104                   = 245, /* Deprecated in 3.4 */
  NDPI_PROTOCOL_EXT_IEC60870              = 246, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_BLOOMBERG             = 247, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_CAPWAP                = 248, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_ZABBIX                = 249, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_S7COMM                = 250, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_MSTEAMS               = 251, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_WEBSOCKET             = 252, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_ANYDESK               = 253, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_SOAP                  = 254, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_NATS                  = 255, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_DOH_DOT               = 256, /* New in 3.4 */
  NDPI_PROTOCOL_EXT_DISCORD               = 257, /* New in 3.4 */

  /*
    IMPORTANT
    Only add new IDs to the end of this list.
    Never remove or modify any existing IDs.
  */

  NDPI_PROTOCOL_EXT_MAX /* Must be last */
} ndpi_protocol_extid_t;
