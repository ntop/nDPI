...
#define NDPI_CURRENT_PROTO NDPI_PROTOCOL_YOUKU
...
void ndpi_search_youku(struct ndpi_detection_module_struct *ndpi_struct, 
		struct ndpi_flow_struct *flow)
{
	struct ndpi_packet_struct *packet = &flow->packet;	
	
	NDPI_LOG_DBG(ndpi_struct, "search youku\n");
	if(packet->payload_packet_len&&strstr(flow->host_server_name,"youku.com")){
