...
#include "../../src/lib/third_party/src/gcrypt.c"
...
int main(void) {
  ...
  int i,num_md = 2000000,num_enc = 10000000, num_dec = 1000000;
    ...
    printf("Test md %.2f sec ", num_md, tdiff2sec(&begin, &end)); fflush(stdout);
    ...
    gettimeofday(&end, NULL);
    printf("enc %.2f sec ", num_enc, tdiff2sec(&begin, &end)); fflush(stdout);
