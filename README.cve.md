...
- CVE-2020-15473 (Jul 01, 2020), the OpenVPN dissector is vulnerable to a heap-based buffer over-read in ndpi_search_openvpn in lib/protocols/openvpn.c, Affected: nDPI < 3.2
- CVE-2020-15472 (Jul 01, 2020), the H.323 dissector is vulnerable to a heap-based buffer over-read,  Affected: nDPI < 3.2

You can read more about nDPI CVEs at https://nvd.nist.gov/vuln/search?keyword=ndpi&resultType=records
